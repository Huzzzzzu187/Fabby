...
const Add = ({ token }) => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
            ...
            <button type="submit" className='w-28 py-3 mt-4 bg-[var(--color-primary)] hover:bg-[var(--color-primary)]/90 transition-all text-white font-bold rounded-xl shadow-sm cursor-pointer'>ADD</button>
